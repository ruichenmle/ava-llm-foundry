...
def convert_composer_to_hf(args: Namespace) -> None:
    ...
    MPTForCausalLM.register_for_auto_class('AutoModelForSeq2SeqLM')
    ...
    if config.model_type == 'mpt':
        ...
        loaded_hf_model = transformers.AutoModelForSeq2SeqLM.from_pretrained(
    ...
    if args.hf_repo_for_upload is not None:
        ...
        if args.test_uploaded_model:
            ...
            hub_model = transformers.AutoModelForSeq2SeqLM.from_pretrained(
